                        ...
                        <div class="col-lg-4">
                            <div class="feature-img">
                                <img class="img-fluid"
                                    ...
                                    src="{{ asset('storage/berita/' . $berita->foto) }}" alt="{{ $berita->judul }}">
                            </div>
                            <div class="mt-3">
                                <span style="margin-right: 16px;"><i
                                        class="lnr lnr-calendar-full"></i>{{ $berita->created_at }}</span>
                                <span style="margin-right: 16px;"><i
                                        class="lnr lnr-eye"></i>{{ $berita->formatted_views }}</span>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <h2 style="color: rgb(42, 42, 42)">{{ $berita->judul }}</h2>
                            <p class="excert" style="color: rgb(53, 53, 53); font-size: 16px;">
                                <strong>{{ $berita->subjudul }}</strong>
                            </p>
                            <p style="color: black">
                                {{ $berita->isi }}
                            </p>
