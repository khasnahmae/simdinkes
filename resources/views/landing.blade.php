...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            z-index: 1030;
            /* Nilai default Bootstrap untuk navbar */
        }
        ...
        .navbar .nav-link {
            color: rgb(0, 0, 0);
            position: relative;
            /* Dibutuhkan untuk membuat garis bawah */
            padding-bottom: 5px;
            /* Beri jarak agar teks tidak terlalu dekat dengan garis */
        }
        ...
        .navbar .nav-link.active {
            ...
            color: rgb(0, 0, 0);
            !important;
            Ubah warna teks jika link aktif
        }
        ...
        .navbar .nav-link.active::after {
            width: 100%;
            /* Tampilkan garis penuh pada hover atau aktif */
        }
        ...
        /* Button Login */
        .login-btn {
            background: linear-gradient(90deg, #4c84af, #4566a0);
            /* Warna hijau gradasi */
            color: white;
        ...
        /* Button Simtik */
        .simtik-btn {
            background: linear-gradient(90deg, #f3db21, #fcd600);
            /* Warna biru gradasi */
            color: black;
        }
...
<body data-bs-spy="scroll" data-bs-target="#navbarNav" data-bs-offset="70" tabindex="0">
    ...
    <nav id="navbarNav" class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a href="#" class="logo d-flex align-items-center">
                <img src="{{ asset('backend/assets/img/kaiadmin/logodinkes.png') }}" alt="navbar brand"
                    class="navbar-brand" style="width: 40px; height: auto;">
            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex align-items-stretch">
                    <img src="{{ asset('images/about.jpg') }}" alt="Tentang Kami" class="img-fluid rounded shadow h-100"
                        style="object-fit: cover;">
                </div>
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h2>DINAS KESEHATAN</h2>
                    <p>
                        Dinas Kesehatan Kota Tegal bertujuan untuk memberikan pelayanan kesehatan terbaik kepada
                        masyarakat. Kami berkomitmen untuk mendukung program kesehatan nasional melalui inovasi, kerja
                        sama, dan pengabdian yang maksimal.
                    </p>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item rounded"><i class="bi bi-check-circle text-success me-2"></i>
                            Program Kesehatan Masyarakat</li>
                        <li class="list-group-item rounded"><i class="bi bi-check-circle text-success me-2"></i>
                            Pengendalian Penyakit dan Imunisasi</li>
                        <li class="list-group-item rounded"><i class="bi bi-check-circle text-success me-2"></i>
                            Edukasi Gaya Hidup Sehat</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
        <div class="footer-center">
            ...
            <p>Email: <a href="mailto:dinkes@tegalkota.go.id">dinkes@tegalkota.go.id</a> | Telepon: <a
                    href="tel:+62283 353351 ">+62283 353351 </a></p>
