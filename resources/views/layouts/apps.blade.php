        ...
        <div class="sidebar" data-background-color="white">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="white">
                    <a href="#" class="logo">
                        <img src="{{ asset('images/siola.png') }}" alt="navbar brand" class="navbar-brand"
                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        <li class="nav-item {{ request()->is('dashboard') ? 'active' : '' }}">
                            <a href="/dashboard" class="{{ request()->is('dashboard') ? '' : 'collapsed' }}"
                        ...
                        @if (Auth::user()->level == 'admin')
                            ...
                            <li
                                class="nav-item {{ request()->is('kegiatan') || request()->is('belanja') || request()->is('detail_belanja') || request()->is('transaksi') ? 'active' : '' }}">
                                <a data-bs-toggle="collapse" href="#formsRka">
                                    <i class="fas fa-chart-pie"></i>
                                    <p>RKA</p>
                                    <span class="caret"></span>
                                </a>
                                <div class="collapse {{ request()->is('kegiatan') || request()->is('belanja') || request()->is('detail_belanja') || request()->is('transaksi') ? 'show' : '' }}"
                                    id="formsRka">
                                    <ul class="nav nav-collapse">
                            ...
                            <li
                                class="nav-item {{ request()->is('atk') || request()->is('bbm') || request()->is('peminjaman-kendaraan') || request()->is('peminjaman-ruangan') ? 'active' : '' }}">
                                <a data-bs-toggle="collapse" href="#formsTransaksi">
                                    <i class="fas fa-cart-plus"></i>
                                    <p>Permintaan</p>
                                    <span class="caret"></span>
                                </a>
                                <div class="collapse {{ request()->is('atk') || request()->is('bbm') || request()->is('peminjaman-kendaraan') || request()->is('peminjaman-ruangan') ? 'show' : '' }}"
                                    id="formsTransaksi">
                                    <ul class="nav nav-collapse">
                        ...
                        <div class="navbar-nav ms-auto me-3">
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                                    ...
                                    <div class="avatar-sm">
                                        @if (Auth::user()->level == 'admin')
                                            <img src="{{ asset('images/profil3.jpg') }}" alt="Admin Avatar"
                                                class="avatar-img rounded-circle" />
                                        @elseif(Auth::user()->level == 'operator')
                                            <img src="{{ asset('images/profil4.jpg') }}" alt="Pimpinan Avatar"
                                                class="avatar-img rounded-circle" />
                                        @else
                                            <img src="{{ asset('images/profil3.jpg') }}" alt="Default Avatar"
                                                class="avatar-img rounded-circle" />
                                        @endif
                                    </div>
                                    <span class="profile-username">
                                        ...
                                        <span class="fw-bold"
                                            style="font-size: 20px; text-transform: uppercase;">{{ Auth::user()->username }}</span>
                                    </span>
                                </a>
                            </li>
                            @if (auth()->user()->level == 'admin' || auth()->user()->level == 'pemimpin')
                                <li class="nav-item topbar-icon dropdown hidden-caret me-3">
                                    <a class="nav-link dropdown-toggle" href="#" id="notifDropdown"
                                        ...
                                        <span
                                            class="notification">{{ $notifications->where('is_read', false)->count() }}</span>
                                    </a>
                                    <ul class="dropdown-menu notif-box animated fadeIn"
                                        aria-labelledby="notifDropdown">
                                        <li>
                                            <div class="dropdown-title">
                                                Kamu memiliki {{ $notifications->where('is_read', false)->count() }}
                                                notifikasi baru.
                                            </div>
                                        </li>
                                        <li>
                                                        ...
                                                        <div class="notif-center">
                                                            @foreach ($notifications as $notification)
                                                                <div class="notif-content">
                                                                    <span
                                                                        class="block">{{ $notification->title }}</span>
                                                                    <span
                                                                    ...
                                                                    @if (!$notification->is_read)
                                                                        <button class="btn btn-link mark-as-read"
