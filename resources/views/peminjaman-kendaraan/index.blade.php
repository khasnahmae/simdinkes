...
@section('content')
    <div class="container">
        <div class="container-fluid d-flex justify-content-between card-header">
            ...
            <a href="{{ route('peminjaman-kendaraan.detail') }}" class="btn btn-info">Lihat Detail</a>
        </div>
        @if (session('success'))
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($pinjam->mulai > $currentTime)
                                        <a href="{{ route('peminjaman-kendaraan.edit', $pinjam->uuid) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <form action="{{ route('peminjaman-kendaraan.destroy', $pinjam->uuid) }}"
