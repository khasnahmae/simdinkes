...
<div class="container py-3">
    ...
    <form action="{{ route('peminjaman-ruangan.update', $peminjaman->uuid) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('peminjaman-ruangan.index')  }}" class="btn btn-outline-secondary btn-sm">Kembali</a>
    </form>
</div>
@endsection
