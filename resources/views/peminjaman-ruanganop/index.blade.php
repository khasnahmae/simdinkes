...
@section('content')
    <div class="container">
        <div class="container-fluid d-flex justify-content-between card-header">
            ...
            <a href="{{ route('peminjaman-ruanganop.create') }}" class="btn btn-primary">Buat Peminjaman Baru</a>
            <a href="{{ route('peminjaman-ruanganop.detail') }}" class="btn btn-info">Lihat Detail</a>
                                ...
                                <td>
                                    @if ($pinjam->user_id === Auth::id())
                                        @if ($pinjam->mulai > $currentTime)
                                            <a href="{{ route('peminjaman-ruanganop.edit', $pinjam->uuid) }}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route('peminjaman-ruanganop.destroy', $pinjam->uuid) }}"
