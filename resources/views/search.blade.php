            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="/berita-all">Berita</a></li>
    ...
    <section class="breadcrumb_area blog_banner_two">
        ...
        <div class="container">
            <div class="page-cover text-center">
                <h2 class="page-cover-tittle f_48">Hasil Pencarian</h2>
                <p style="color: white">Menampilkan hasil pencarian untuk: <strong>"{{ $query }}"</strong></p>
            </div>
            @if (session('success'))
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 posts-list">
                    @if ($berita->isEmpty())
                        <p class="text-muted">Tidak ada berita yang sesuai dengan kata kunci "{{ $query }}".
                        </p>
                    @else
                                ...
                                <div class="col-lg-4">
                                    <div class="feature-img">
                                        <img class="img-fluid"
                                            ...
                                            src="{{ asset('storage/berita/' . $item->foto) }}"
                                            alt="{{ $item->judul }}">
                                    </div>
                                    <div class="mt-3">
                                        <span style="margin-right: 16px;">
                                            <i class="lnr lnr-calendar-full"></i>{{ $item->created_at }}
                                        </span>
                                        <span style="margin-right: 16px;">
                                            <i class="lnr lnr-eye"></i>{{ $item->formatted_views }}
                                        </span>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <h2 style="color: rgb(42, 42, 42)">{{ $item->judul }}</h2>
                                    <p class="excert" style="color: rgb(53, 53, 53); font-size: 16px;">
                                        <strong>{{ $item->subjudul }}</strong>
                                    </p>
                                    <p style="color: black">
                                        {{ \Illuminate\Support\Str::limit($item->isi, 300, '...') }}
                                    </p>
                                    <a href="{{ route('berita-show', ['id' => $item->id]) }}"
                                        class="btn-read-more">Baca
                                        Selengkapnya</a>
                                </div>
