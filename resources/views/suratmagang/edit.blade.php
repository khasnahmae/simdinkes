...
<div class="container py-3">
    <h4 class="card-title">Edit Data File Surat</h4>
    <form action="{{ route('suratmagang.update', $suratmagang->uuid) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kampus" class="form-control" id="nama_kampus" value="{{ $suratmagang->nama_kampus }}" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
