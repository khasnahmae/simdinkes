          ...
          class="display table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($item->status === 'Disetujui')
                            <a href="{{ route('tr_bbm.print', $item->id) }}" class="btn btn-info btn-sm">
                                Cetak
                            </a>
                        @endif
                        @if($item->status === 'Pengajuan')
                            <a href="{{ route('tr_bbm.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('tr_bbm.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
