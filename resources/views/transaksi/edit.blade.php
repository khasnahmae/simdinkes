                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="detail_belanja_id" id="detail_belanja_id" class="form-control" required
                                onchange="fetchDetailBelanjaData()">
                                <option value="">Pilih Detail Belanja</option>
                                @foreach ($detail_belanjas as $detail)
                                    <option value="{{ $detail->id }}"
                                        {{ $transaksi->detail_belanja_id == $detail->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_kegiatan" name="nama_kegiatan" class="form-control"
                                value="{{ $transaksi->nama_kegiatan }}" readonly required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="satuan" name="satuan" class="form-control"
                                value="{{ $transaksi->satuan }}" readonly required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <small id="harga_alert" class="text-danger" style="display:none;">Harga melebihi
                                anggaran!</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_penyedia" id="nama_penyedia" class="form-control"
                                value="{{ $transaksi->nama_penyedia }}" required>
                        </div>
                    </div>
                </div>
            </div>
